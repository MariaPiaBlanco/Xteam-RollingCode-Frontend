...
function Carousel() {
  return (
    <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
      <div className="carousel-inner">
        <div className="carousel-item active">
          ...
          <div className="carousel-caption d-none d-md-block col-3 ms-0 ps-0">
            ...
            <button type="button" className="btn btn-lg btnCarousel text-light">Primary button</button>
          </div>
        </div>
      ...
      <div className="barCarousel text-light"><h1>Titulo</h1> <h2>Subtitulo</h2></div>
</div>
  );
}
